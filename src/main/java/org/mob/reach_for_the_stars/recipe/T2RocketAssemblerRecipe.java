...
public class T2RocketAssemblerRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> inputs;
    private final List<Integer> inputCounts;

    public T2RocketAssemblerRecipe(ResourceLocation id, NonNullList<Ingredient> inputs, List<Integer> inputCounts, ItemStack output) {
        this.id = id;
        this.inputs = inputs;
    ...
    public static class Type implements RecipeType<T2RocketAssemblerRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "t2_rocket_assembler";
    }

    public static class Serializer implements RecipeSerializer<T2RocketAssemblerRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = resourceLocation("t2_rocket_assembler");

        @Override
        public T2RocketAssemblerRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new T2RocketAssemblerRecipe(recipeId, inputs, counts, result);
        }

        @Override
        public T2RocketAssemblerRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            ...
            return new T2RocketAssemblerRecipe(recipeId, inputs, counts, output);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buffer, T2RocketAssemblerRecipe recipe) {
