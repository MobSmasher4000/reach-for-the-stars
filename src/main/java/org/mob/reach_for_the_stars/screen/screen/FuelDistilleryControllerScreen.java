...
public class FuelDistilleryControllerScreen extends AbstractContainerScreen<FuelDistilleryControllerMenu> {

    private static final ResourceLocation TEXTURE = resourceLocation("textures/gui/multiblock_gui.png");

    public FuelDistilleryControllerScreen(FuelDistilleryControllerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
