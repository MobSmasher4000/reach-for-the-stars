...
public class T5RocketAssemblerRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> inputs;
    private final List<Integer> inputCounts;

    public T5RocketAssemblerRecipe(ResourceLocation id, NonNullList<Ingredient> inputs, List<Integer> inputCounts, ItemStack output) {
        this.id = id;
        this.inputs = inputs;
    ...
    public static class Type implements RecipeType<T5RocketAssemblerRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "t5_rocket_assembler";
    }

    public static class Serializer implements RecipeSerializer<T5RocketAssemblerRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = resourceLocation("t5_rocket_assembler");

        @Override
        public T5RocketAssemblerRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new T5RocketAssemblerRecipe(recipeId, inputs, counts, result);
        }

        @Override
        public T5RocketAssemblerRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            ...
            return new T5RocketAssemblerRecipe(recipeId, inputs, counts, output);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buffer, T5RocketAssemblerRecipe recipe) {
