...
public class T1RocketAssemblerControllerScreen extends AbstractContainerScreen<T1RocketAssemblerControllerMenu> {

    private static final ResourceLocation TEXTURE = resourceLocation("textures/gui/multiblock_rocket_gui.png");

    public T1RocketAssemblerControllerScreen(T1RocketAssemblerControllerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
