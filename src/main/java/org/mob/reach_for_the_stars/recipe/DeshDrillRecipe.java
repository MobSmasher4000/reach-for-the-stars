...
public class DeshDrillRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final FluidStack fluidInput;
    private final ItemStack output;
    private final ResourceLocation dimension;

    public DeshDrillRecipe(ResourceLocation id, FluidStack fluidInput, ItemStack output, ResourceLocation dimension) {
        this.id = id;
    ...
    public static class Type implements RecipeType<DeshDrillRecipe>{
        private Type(){}
        public static final DeshDrillRecipe.Type INSTANCE = new DeshDrillRecipe.Type();
        public static final String ID = "desh_drill";
    }

    public static class Serializer implements RecipeSerializer<DeshDrillRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = resourceLocation("desh_drill");

        @Override
        public DeshDrillRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            // Read "fluid" object
            ...
            return new DeshDrillRecipe(pRecipeId, fluidInput, output, dimension);
        }

        @Override
        public @Nullable DeshDrillRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, DeshDrillRecipe pRecipe) {
