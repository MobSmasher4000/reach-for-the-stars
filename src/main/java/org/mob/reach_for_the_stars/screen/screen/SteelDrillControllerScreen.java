...
public class SteelDrillControllerScreen extends AbstractContainerScreen<SteelDrillControllerMenu> {

    private static final ResourceLocation TEXTURE = resourceLocation("textures/gui/multiblock_gui.png");

    public SteelDrillControllerScreen(SteelDrillControllerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
