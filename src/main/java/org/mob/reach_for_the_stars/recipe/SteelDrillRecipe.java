...
public class SteelDrillRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final FluidStack fluidInput;
    private final ItemStack output;
    private final ResourceLocation dimension;

    public SteelDrillRecipe(ResourceLocation id, FluidStack fluidInput, ItemStack output, ResourceLocation dimension) {
        this.id = id;
    ...
    public static class Type implements RecipeType<SteelDrillRecipe>{
        private Type(){}
        public static final SteelDrillRecipe.Type INSTANCE = new SteelDrillRecipe.Type();
        public static final String ID = "steel_drill";
    }

    public static class Serializer implements RecipeSerializer<SteelDrillRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = resourceLocation("steel_drill");

        @Override
        public SteelDrillRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            // Read "fluid" object
            ...
            return new SteelDrillRecipe(pRecipeId, fluidInput, output, dimension);
        }

        @Override
        public @Nullable SteelDrillRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, SteelDrillRecipe pRecipe) {
