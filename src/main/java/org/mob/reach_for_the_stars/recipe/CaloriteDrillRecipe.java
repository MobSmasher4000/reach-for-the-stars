...
public class CaloriteDrillRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final FluidStack fluidInput;
    private final ItemStack output;
    private final ResourceLocation dimension;

    public CaloriteDrillRecipe(ResourceLocation id, FluidStack fluidInput, ItemStack output, ResourceLocation dimension) {
        this.id = id;
    ...
    public static class Type implements RecipeType<CaloriteDrillRecipe>{
        private Type(){}
        public static final CaloriteDrillRecipe.Type INSTANCE = new CaloriteDrillRecipe.Type();
        public static final String ID = "calorite_drill";
    }

    public static class Serializer implements RecipeSerializer<CaloriteDrillRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = resourceLocation("calorite_drill");

        @Override
        public CaloriteDrillRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            // Read "fluid" object
            ...
            return new CaloriteDrillRecipe(pRecipeId, fluidInput, output, dimension);
        }

        @Override
        public @Nullable CaloriteDrillRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, CaloriteDrillRecipe pRecipe) {
