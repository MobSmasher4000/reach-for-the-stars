...
public class T4RocketAssemblerControllerScreen extends AbstractContainerScreen<T4RocketAssemblerControllerMenu> {

    private static final ResourceLocation TEXTURE = resourceLocation("textures/gui/multiblock_rocket_gui.png");

    public T4RocketAssemblerControllerScreen(T4RocketAssemblerControllerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
