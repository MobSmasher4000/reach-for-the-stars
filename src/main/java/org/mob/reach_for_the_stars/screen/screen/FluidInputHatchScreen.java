...
public class FluidInputHatchScreen extends AbstractContainerScreen<FluidInputHatchMenu> {
    ...
    public FluidInputHatchScreen(FluidInputHatchMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
