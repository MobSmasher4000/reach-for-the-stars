...
public class T3RocketAssemblerControllerScreen extends AbstractContainerScreen<T3RocketAssemblerControllerMenu> {

    private static final ResourceLocation TEXTURE = resourceLocation("textures/gui/multiblock_rocket_gui.png");

    public T3RocketAssemblerControllerScreen(T3RocketAssemblerControllerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
