...
public class T2RocketAssemblerControllerScreen extends AbstractContainerScreen<T2RocketAssemblerControllerMenu> {

    private static final ResourceLocation TEXTURE = resourceLocation("textures/gui/multiblock_rocket_gui.png");

    public T2RocketAssemblerControllerScreen(T2RocketAssemblerControllerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
