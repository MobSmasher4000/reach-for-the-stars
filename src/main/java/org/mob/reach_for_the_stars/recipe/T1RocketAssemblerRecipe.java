...
public class T1RocketAssemblerRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> inputs;
    private final List<Integer> inputCounts;

    public T1RocketAssemblerRecipe(ResourceLocation id, NonNullList<Ingredient> inputs, List<Integer> inputCounts, ItemStack output) {
        this.id = id;
        this.inputs = inputs;
    ...
    public static class Type implements RecipeType<T1RocketAssemblerRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "t1_rocket_assembler";
    }

    public static class Serializer implements RecipeSerializer<T1RocketAssemblerRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = resourceLocation("t1_rocket_assembler");

        @Override
        public T1RocketAssemblerRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            return new T1RocketAssemblerRecipe(recipeId, inputs, counts, result);
        }

        @Override
        public T1RocketAssemblerRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
            ...
            return new T1RocketAssemblerRecipe(recipeId, inputs, counts, output);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buffer, T1RocketAssemblerRecipe recipe) {
